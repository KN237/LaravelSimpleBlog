            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="edit_user_form" method="POST" action="{{route('create.user')}}" enctype="multipart/form-data">
                            @method('POST')
                            @csrf
                            <div class="position-relative form-group">
                                <label for="exampleEmail" class="">Nom</label>
                                <input name="name" id="exampleEmail" type="text" class="form-control">
                            </div>
